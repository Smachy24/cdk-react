...
function Inscription() {
  return (
    <div className="body font-sans m-0 p-0 bg-gray-900 text-black flex items-center justify-center h-screen">
      <div className="container w-full max-w-md text-center">
        <div className="signup-box bg-opacity-80 bg-black p-10 rounded-lg">
          ...
          <form className="flex flex-col">
            ...
            <input type="text" id="name" name="name" required className="p-2 mb-4 border border-gray-700 rounded-md" />

            <label htmlFor="prenom" className="text-sm mb-1">Prenom :</label>
            <input type="text" id="prenom" name="prenom" required className="p-2 mb-4 border border-gray-700 rounded-md" />


            <label htmlFor="date" className="text-sm mb-1">Date de naissance :</label>
            <input type="text" id="date" name="date" required className="p-2 mb-4 border border-gray-700 rounded-md" />
          ...
          <p className="signin-link mt-4 text-sm">Avez-vous déjà un compte? </p>
        </div>
      </div>
    </div>
  );
